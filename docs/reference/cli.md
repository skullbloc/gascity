...
| [gc dolt gc-nudge](#gc-dolt-gc-nudge) | Size-triggered CALL DOLT_GC() to compact a bloated Dolt database |
...
Size-triggered CALL DOLT_GC() to compact a bloated Dolt database
